...
export default function RegisterScreen() {
  ...
  const validateForm = () => {
    ...
    if (!form.password) {
      ...
      newErrors.password = "Must be 8+ characters with a letter & number";
    }
  ...
  const handleRegister = async () => {
    ...
    setLoading(true);
    try {
      // Replace '192.168.x.x' with your computer's actual IPv4 address
      // You can find this by typing 'ipconfig' in your Windows terminal
      const API_URL = "http://192.168.8.184:5000/api/users/register"; 
